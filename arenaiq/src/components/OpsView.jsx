  ...
  return (
    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}>
        <span style={{ ...font, fontSize: '0.6875rem', color: T.text4, fontWeight: 400 }}>
          {alert.time}
        </span>
        <span
          style={{
    ...
    <div className="ops-grid" style={{ display: 'grid', gap: 16 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <Card style={{ flex: '0 0 auto' }}>
          ...
          >
            {gameState.alerts.length === 0 ? (
              ...
              [...gameState.alerts]
                .reverse()
                .map((alert, i) => <AlertCard key={alert.id} alert={alert} idx={i} />)
            )}
          </div>
        </Card>
        ...
        <Card style={{ flex: '0 0 auto' }}>
          ...
          >
            {gameState.aiInsight || 'No insights available yet.'}
          </div>
        </Card>
